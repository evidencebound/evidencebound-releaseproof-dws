...
CANONICAL_LIVE_EVIDENCE = {
    ...
    "historical_hosted_differential_reverification": "BLOCKED_QUOTA_402",
    "historical_quota_boundary_run_id": 32215515505,
}
...
def live_evidence() -> dict:
    return {
        "historical_processor_core": CANONICAL_LIVE_EVIDENCE,
        "dws_native_v2_core": V2_HOSTED_EVIDENCE,
    }
